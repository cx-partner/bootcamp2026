...
If you have been assigned a Cisco lab Pod, here you will find the details of your account and the users assigned. 

If the **Pod#** has been allocated to you, the *#* number will determine the users you will use. In the table below, replace the *#* by the Pod number assigned.
...
Airtable: you must create your own Airtable Base and the required tables. 